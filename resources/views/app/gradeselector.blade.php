...
<div class="container">
    <div class="row">
        <h1 class="display-6 text-info mb-1 text-dark"><a class="backspan fs-2" href="/"><i class="backspan bi bi-arrow-90deg-up"></i></a> {{ $subjectname }}</h1>
                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        <div class="order-2 order-lg-1 col-lg-6">
                            <form method="GET" action="/list-guides">
                                @csrf
